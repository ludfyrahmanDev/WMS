    ...
    <div class="intro-y flex items-center mt-8">
        ...
        <div class="flex items-center space-x-2">
            <div class="hidden md:flex items-center text-slate-600">
                <x-base.lucide class="w-4 h-4 mr-2" icon="Grid" />
                <span class="text-sm">Total: {{ $data->total() }} kategori</span>
            </div>
        </div>
    </div>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    <x-base.form-input class="!box w-64 pr-10 bg-slate-50 border-slate-300" type="text" id="search"
                        value="{{ request()->get('search') }}" placeholder="Cari kategori..." />
                            ...
                            <x-base.table.tr>
                                <x-base.table.td colspan="4" class="py-12 text-center border-b border-slate-200">
                                    <div class="flex flex-col items-center justify-center">
                                        <x-base.lucide class="w-16 h-16 text-slate-300 mb-4" icon="Grid" />
                                        <h3 class="text-lg font-medium text-slate-600 mb-2">Tidak ada data kategori</h3>
                                        <p class="text-slate-500 mb-4">Belum ada kategori yang terdaftar dalam sistem</p>
                                        <a href="{{ route($route . '.create') }}">
