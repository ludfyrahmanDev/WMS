            ...
            <form action="{{ $route }}" method="post" enctype="multipart/form-data">
                ...
                <div class="intro-y box p-5">
                    <div class="input-form">
                        ...
                        <x-base.form-input class="w-full" id="crud-form-1" type="text" required name="name"
                            value="{{ $data->name ?? old('name') }}" placeholder="Input Nama" />
                        @error('name')
                    ...
                    <div class="mt-3 input-form">
                        ...
                        <x-base.form-input class="w-full" id="crud-form-1" type="email"
                            value="{{ $data->email ?? old('email') }}" required name="email" placeholder="Input Email" />
                    </div>
                    <div class="mt-3 input-form">
                        <x-base.form-label for="crud-form-1">Password <sup style="color:red">*minimal 6
                                digit</sup></x-base.form-label>
                        <x-base.form-input class="w-full" id="crud-form-1" type="password" name="password"
                            placeholder="Input Password" />
                    </div>
                    <div class="mt-3 input-form">
                        <x-base.form-label for="crud-form-1">Password Konfirmasi <sup style="color:red">*minimal 6
                                digit</sup></x-base.form-label>
                    ...
                    <div class="mt-3 input-form">
                        ...
                        <x-base.form-select id="category" name='role' required>
                            ...
                            @foreach ($role as $item)
                                <option value="{{ $item['value'] }}" {{ $oldrole == $item['value'] ? 'selected' : '' }}>
                                    {{ $item['label'] }}</option>
                            @endforeach
                        </x-base.form-select>
                    </div>
                    <div class="mt-3 input-form">
                        ...
                        <x-base.form-select id="gender" name='gender' required>
                            ...
                            @foreach ($gender as $item)
                                <option value="{{ $item['value'] }}" {{ $oldGender == $item['value'] ? 'selected' : '' }}>
                                    {{ $item['label'] }}</option>
                            @endforeach
                        </x-base.form-select>
                    </div>
                    <div class="mt-3 input-form">
                        ...
                        <x-base.form-input class="w-full" id="crud-form-1" type="file" name="file"
                            placeholder="Input Password Konfirmasi" />
                    </div>

                    <div class="mt-5 text-right">
                        <x-base.button class="mr-1 w-24" type="button" variant="outline-secondary">
                            <a href="{{ route('users.index') }}" variant="outline-secondary">
                                Cancel
                            </a>
                        </x-base.button>
