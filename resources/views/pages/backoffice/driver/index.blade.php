    ...
    <div class="intro-y mt-8">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center space-x-4">
                <div class="flex items-center justify-center w-12 h-12 bg-teal-100 rounded-xl">
                    <x-base.lucide class="w-6 h-6 text-teal-600" icon="Users" />
                </div>
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">{{ $title }}</h1>
                    <p class="text-slate-600 mt-1">Kelola data driver dan pengemudi kendaraan</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 p-4 rounded-lg text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-teal-100 text-sm">Total Driver</p>
                        <p class="text-2xl font-bold">{{ $data->total() ?? 0 }}</p>
                    </div>
                    <x-base.lucide class="w-8 h-8 text-teal-200" icon="Users" />
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route($route . '.create') }}">
                        <x-base.button class="w-full sm:w-auto bg-teal-600 hover:bg-teal-700 text-white shadow-lg shadow-teal-600/20" variant="primary">
                ...
                <div class="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
                    <form method="GET" action="{{ route($route . '.index') }}" class="flex-1 sm:flex-initial">
                        <div class="relative">
                            ...
                            <x-base.form-input
                                id="search"
                                class="pl-10 pr-4 py-2 w-full sm:w-64 border-slate-300 focus:border-teal-500 focus:ring-teal-500 rounded-lg"
                                name="search"
                                type="text"
                        ...
                        @forelse ($data as $item)
                            <x-base.table.tr class="intro-x hover:bg-slate-50 transition-colors duration-200">
                                ...
                                <x-base.table.td class="py-4 px-6 border-b border-slate-200">
                                    <div class="flex items-center">
                                        <div class="flex items-center justify-center w-10 h-10 bg-teal-100 text-teal-600 rounded-full mr-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-slate-500">{{ $item['license_number'] ?? 'SIM tidak tersedia' }}</div>
                                        </div>
                                    </div>
                                </x-base.table.td>
                                <x-base.table.td class="py-4 px-6 border-b border-slate-200">
                            ...
                            <x-base.table.tr>
                                <x-base.table.td colspan="6" class="py-12 text-center border-b border-slate-200">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-lg font-medium text-slate-600 mb-2">Tidak ada data driver</h3>
                                        <p class="text-slate-500 mb-4">Belum ada driver yang terdaftar dalam sistem</p>
                                        <a href="{{ route($route . '.create') }}">
