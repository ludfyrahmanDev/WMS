    ...
    <div class="intro-y flex items-center mt-8">
        ...
        <div class="flex items-center space-x-2">
            <div class="hidden md:flex items-center text-slate-600">
                ...
                <span class="text-sm">Total: {{ $data->total() }} supplier</span>
            </div>
        </div>
    </div>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    <x-base.form-input class="!box w-64 pr-10 bg-slate-50 border-slate-300" type="text" id="search"
                        value="{{ request()->get('search') }}" placeholder="Cari supplier..." />
                        ...
                        @forelse ($data as $item)
                            <x-base.table.tr class="intro-x hover:bg-slate-50 transition-colors duration-200">
                                ...
                                <x-base.table.td class="py-4 px-6 border-b border-slate-200">
                                    <div class="flex items-center">
                                        <div class="flex items-center justify-center w-10 h-10 bg-orange-100 text-orange-600 rounded-full mr-3">
                                            <x-base.lucide class="w-5 h-5" icon="Building" />
                                        </div>
                                        <div>
                                            <div class="font-semibold text-slate-800">{{ $item['name'] }}</div>
                                            <div class="text-sm text-slate-500">{{ $item['npwp'] ?? 'NPWP tidak tersedia' }}</div>
                                        </div>
                                    </div>
                                </x-base.table.td>
                                <x-base.table.td class="py-4 px-6 border-b border-slate-200">
                            ...
                            <x-base.table.tr>
                                <x-base.table.td colspan="5" class="py-12 text-center border-b border-slate-200">
                                    <div class="flex flex-col items-center justify-center">
                                        <x-base.lucide class="w-16 h-16 text-slate-300 mb-4" icon="Building" />
                                        <h3 class="text-lg font-medium text-slate-600 mb-2">Tidak ada data supplier</h3>
                                        <p class="text-slate-500 mb-4">Belum ada supplier yang terdaftar dalam sistem</p>
                                        <a href="{{ route($route . '.create') }}">
